...
{
	[CustomPropertyDrawer(typeof(SliderPair))]
	public class SliderPairDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			EditorGUI.PropertyField(sliderRect, property.FindPropertyRelative("slider"), GUIContent.none);
